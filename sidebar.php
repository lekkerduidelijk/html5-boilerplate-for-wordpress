...
<aside id="secondary">
	<?php   /* Widgetized sidebar, if you have the plugin installed. */
		if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar() ) : ?>
			...
			<nav role="navigation">
				<?php wp_list_pages('title_li=<h2>'. __('Pages', 'html5-boilerplate-for-wordpress') . '</h2>' ); ?>
				
				<h2><?php _e('Archives','html5-boilerplate-for-wordpress') ?></h2>
				<ul>
					<?php wp_get_archives('type=monthly'); ?>
				</ul>
				
				<?php wp_list_categories('show_count=1&title_li=<h2>'. __('Categories','html5-boilerplate-for-wordpress') .'</h2>'); ?>
			</nav>
			...
			<nav>
				<ul>
					<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
						...
						<li><h2><?php _e('Meta','html5-boilerplate-for-wordpress') ?></h2>
							<ul>
								<?php wp_register(); ?>
